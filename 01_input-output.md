...
Пример: программа `print(2 + 7)` выводит число 9.
...
А вот сложить число и строку не получится. Если мы все-таки хотим это сделать, сначала нужно изменить тип данных числа на текстовый:
